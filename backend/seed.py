...
with app.app_context():
    pizza1 = Pizza(name='Barbeque', ingredients='Dough, Tomato Sauce,beef,Cheese')
    pizza2 = Pizza(name='Pepperoni', ingredients='Dough, Tomato Sauce, Cheese, Pepperoni')

    # Create sample restaurants
    restaurant1 = Restaurant(name='Eeeman', address='568 Atlantic Ave, Brooklyn, NY 11201')
    restaurant2 = Restaurant(name='Aticas', address='69 W 78th St, New York, NY 10019')
    ...
    restaurant_pizza3 = RestaurantPizza(price=5, pizza=pizza1, restaurant=restaurant2)
